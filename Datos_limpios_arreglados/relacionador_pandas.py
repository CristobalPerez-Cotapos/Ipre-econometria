...
def col_names(año, datos):
    if año < 2014:
        datos.columns = ["region", "sexo", "edad", "nhijos", "ephijo",
                         "ytrabaj", "ytrabajh", "horas", "tsec", "esc", "e6b"]
    else:
        datos.columns = ["region", "sexo", "edad", "nhijos", "ephijo",
...
def relacionador(año_1, año_2, sexo):
    ...
    resultado.to_csv(f"{año_1}_{año_2}.csv", index=False)


relacionador(2011, 2013, 2)
relacionador(2013, 2015, 2)
relacionador(2015, 2017, 2)
relacionador(2011, 2015, 2)
relacionador(2011, 2017, 2)
relacionador(2013, 2017, 2)
